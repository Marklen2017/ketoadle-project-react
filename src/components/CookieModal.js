...
export default function CookiesScreen() {
    ...
    return (
        <div style={{margin:20}}>
            <div style={{fontSize:24,fontWeight:'bold'}}>Cookies, Legal & Privacy Policy</div>
            <pre style={{width: '100%',marginTop:20,fontSize:'16'}}>
            Privacy Policy of www.ketoadle.com<br/>
...
<br/>
Ketoadle Philips Road, Bacup, Lancashire, OL138RH<br/>

Owner contact email: privacy@ketoadle.com<br/>

Types of Data collected<br/>

Among the types of Personal Data that this Application collects, by itself or through third parties, there are: email address; first name; last name; Cookies; phone number; profession; county; state; country; ZIP/Postal code; date of birth; city; address; company name; Usage Data; Calendar permission; Contacts permission; Camera permission; Microphone permission; Storage permission; Reminders permission; Microphone permission, without recording; Call permission; Camera permission, without saving or recording.
...
Usage Data
<br/>
Information collected automatically through this Application (or third-party services employed in this Application), which can include: the IP addresses or domain names of the computers utilized by the Users who use this Application, the URI addresses (Uniform Resource Identifier), the time of the request, the method utilized to submit the request to the server, the size of the file received in response, the numerical code indicating the status of the server's answer (successful outcome, error, etc.), the country of origin, the features of

the browser and the operating system utilized by the User, the various time details per visit (e.g., the time spent on each page within the Application) and the details about the path followed within the Application with special reference to the sequence of pages visited, and other parameters about the device operating system and/or the User's IT environment.
<br/>
User
<br/>
...
<br/>
Latest update: February 14, 2020 iubenda hosts this content and only collects the Personal Data strictly necessary for it to be provided.
        </pre>
        </div>
    );
}
