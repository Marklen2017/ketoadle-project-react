        ...
        footer={
          <Card.Footer>
            <div className="d-flex">
              ...
              <Button type="submit" color="primary" style={{backgroundColor:'#4267b2',borderColor:'#4267b2'}} className="ml-auto">
                Send data
              </Button>
            </div>
          </Card.Footer>
              ...
              <Form.Group label="Input Group Buttons">
                <Form.InputGroup>
                  ...
                  <Form.InputGroup append>
                    <Button color="primary" style={{backgroundColor:'#4267b2',borderColor:'#4267b2'}}>Actions</Button>
                    <Button.Dropdown color="primary" style={{backgroundColor:'#4267b2',borderColor:'#4267b2'}}>
